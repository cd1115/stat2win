              ...
              <div className="mt-8 grid gap-2 sm:grid-cols-2">
                <button
                  ...
                  className={cn(
                    ...
                    locked ? "bg-white/10 text-white/60" : "bg-white/10 hover:bg-white/15",
                  )}
                  disabled={locked}
                >
                  Buy
                ...
                <button
                  ...
                  className={cn(
                    "rounded-2xl px-4 py-3 text-sm font-semibold",
                    locked || ui.status === "loading" || (product.pointsCost && !canRedeem)
                      ? "bg-blue-600/40 text-white/70"
                      : "bg-blue-600 hover:bg-blue-500",
                  )}
                  disabled={locked || ui.status === "loading" || (product.pointsCost ? !canRedeem : true)}
                >
